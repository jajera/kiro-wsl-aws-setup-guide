...
![Kiro IDE showing WSL connection targets in Remote Explorer](/images/kiro-wsl-targets.png)
...
![Kiro workspace trust dialog when opening a project folder](/images/kiro-workspace-trust.png)
