...
![Docker Desktop installer configuration screen with Use WSL 2 checked and Windows Containers unchecked](/images/docker-desktop-installer-configuration.png)
